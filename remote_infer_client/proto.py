...
@dataclass
class SdwTxt2ImgResponse(JSONe):
    images: List[str]
...
@dataclass
class SdwProgressData(JSONe):
    progress: int
    eta_relative: int
    current_images: Optional[str] = None
...
@dataclass
class SdwOptions(JSONe):
    sd_model_checkpoint: str


@dataclass
class SdwModelInfoCheckpoint(JSONe):
    title: str
    model_name: str
    hash: str
    type: Optional[ModelType] = ModelType.CHECKPOINT


@dataclass
class SdwModelInfoLora(JSONe):
    name: str
    alias: Optional[str] = None
    hash: Optional[str] = None
    type: Optional[ModelType] = ModelType.LORA


@dataclass
class SdwModelInfoUpscaler(JSONe):
    name: str
    hash: Optional[str] = None
    type: Optional[ModelType] = ModelType.UPSCALER
